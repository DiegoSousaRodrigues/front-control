...
export const Wrapper = w.div('flex bg-gray-50 h-full')
...
export const AccordionItem = styled(Accordion.Item, {
  className: 'data-[state=open]:border border-blue-500 rounded-md ',
})

export const AccordionTrigger = styled(Accordion.Trigger, {
  className:
    'group w-full py-4 px-4 hover:bg-gray-100 rounded-md data-[state=open]:bg-gray-100 data-[state=open]:text-blue-500',
})
